                    ...
                    <Column className="items-start w-[58%]">
                      ...
                      <div className="2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] mt-[16px] w-[100%] xl:mt-[10px] input-wrap">
                        <Image
                          ...
                          className="absolute h-[24px] right-[32px] lg:h-[14px] lg:right-[18px] xl:h-[17px] xl:right-[21px] 2xl:h-[19px] 2xl:right-[24px] 3xl:h-[22px] 3xl:right-[28px] my-[auto] inset-y-[0]"
                          alt="chevron-down"
                        />
                        <Button className="border border-bluegray_100 border-solid font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.545px] lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] pl-[32px] 3xl:pr-[100px] pr-[112px] lg:pr-[65px] xl:pr-[74px] 2xl:pr-[84px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[100%]">{`Select State`}</Button>
                      </div>
                    </Column>
                  ...
                  <Row className="lg:gap-[19px] xl:gap-[22px] 2xl:gap-[24px] 3xl:gap-[29px] gap-[33px] grid grid-cols-3 items-center justify-between lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] w-[100%]">
                    ...
                    <div className="bg-transparent border-0 w-[100%] input-wrap">
                      <Image
                        ...
                        className="absolute h-[40px] left-[33px] bg-transparent border-0 lg:h-[24px] lg:left-[19px] xl:h-[27px] xl:left-[22px] 2xl:h-[31px] 2xl:left-[24px] 3xl:h-[37px] 3xl:left-[29px] my-[auto] inset-y-[0]"
                        alt="transfer"
                      />
                      <Input
                        className="bg-gray_800 placeholder:bg-transparent border border-bluegray_100 border-solid font-normal not-italic lg:pb-[18px] xl:pb-[21px] 2xl:pb-[24px] 3xl:pb-[29px] pb-[32.545px] pl-[106px] lg:pl-[61px] xl:pl-[70px] 2xl:pl-[79px] 3xl:pl-[95px] lg:pt-[19px] xl:pt-[22px] 2xl:pt-[25px] 3xl:pt-[30px] pt-[33.545px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left placeholder:text-white_A700 text-white_A700 w-[100%]"
                        name="Bank Transfer"
                    ...
                    <div className="w-[100%] input-wrap">
                      <Image
                        src="img_paypal.svg"
                        className="absolute h-[40px] left-[64px] lg:h-[24px] lg:left-[37px] xl:h-[27px] xl:left-[42px] 2xl:h-[31px] 2xl:left-[48px] 3xl:h-[37px] 3xl:left-[57px] my-[auto] inset-y-[0]"
                        alt="paypal"
                      />
                      <Button className="border border-bluegray_100 border-solid font-normal not-italic lg:pb-[18px] xl:pb-[21px] 2xl:pb-[24px] 3xl:pb-[29px] pb-[32.545px] xl:pl-[112px] 2xl:pl-[126px] 3xl:pl-[151px] pl-[168px] lg:pl-[98px] lg:pt-[19px] xl:pt-[22px] 2xl:pt-[25px] 3xl:pt-[30px] pt-[33.545px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_800 text-left w-[100%]">{`Paypal`}</Button>
                    </div>
                  </Row>
                  <Column className="items-start justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                    ...
                    <Column className="items-start w-[100%]">
                      ...
                      <div className="2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] mt-[16px] w-[100%] xl:mt-[10px] input-wrap">
                        <Image
                          ...
                          alt="chevron-down"
                        />
                        <Button className="border border-bluegray_100 border-solid font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.545px] lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] pl-[32px] 3xl:pr-[100px] pr-[112px] lg:pr-[65px] xl:pr-[74px] 2xl:pr-[84px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[100%]">{`Select Month`}</Button>
                      </div>
                    </Column>
                    <Column className="items-start w-[100%]">
                      ...
                      <div className="2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] mt-[16px] w-[100%] xl:mt-[10px] input-wrap">
                        <Image
                          ...
                          alt="chevron-down"
                        />
                        <Button className="border border-bluegray_100 border-solid font-normal not-italic xl:pb-[11px] 3xl:pb-[15px] pb-[17.545px] lg:pl-[18px] xl:pl-[21px] 2xl:pl-[24px] 3xl:pl-[28px] pl-[32px] 3xl:pr-[100px] pr-[112px] lg:pr-[65px] xl:pr-[74px] 2xl:pr-[84px] xl:pt-[12px] 3xl:pt-[16px] pt-[18.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[100%]">{`Select Year`}</Button>
                      </div>
                    </Column>
                  </Row>
                </Column>
                <Column className="items-end lg:mt-[43px] xl:mt-[50px] 2xl:mt-[56px] 3xl:mt-[67px] mt-[75px] w-[100%]">
                  <Button className="bg-gray_800 font-medium ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:py-[10px] xl:py-[12px] 2xl:py-[13px] 3xl:py-[16px] py-[18.045px] text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-white_A700 w-[31%]">{`Checkout`}</Button>
                </Column>
              </Column>
            </Row>
              ...
              <Column className="bg-gray_800 items-center justify-end w-[100%]">
                <Row className="items-start justify-evenly lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] mt-[64px] w-[100%]">
                  ...
                  <Row className="items-start justify-center w-[56%]">
                    ...
                    <Column className="items-start justify-start lg:mb-[41px] xl:mb-[47px] 2xl:mb-[53px] 3xl:mb-[63px] mb-[71px] lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] w-[35%]">
