                  ...
                  <Stack className="lg:h-[409px] xl:h-[468px] 2xl:h-[526px] 3xl:h-[631px] h-[700px] w-[49%]">
                    ...
                    <Column className="absolute h-[max-content] inset-y-[0] items-start justify-start left-[0] my-[auto] w-[70%]">
                      ...
                      <Row className="bg-gray_800 font-poppins items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[37%]">
                        ...
                        <Image
                          src="img_arrow.svg"
                          className="lg:h-[28px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] h-[48px] ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:my-[3px] 2xl:my-[4px] xl:my-[4px] 3xl:my-[5px] my-[6px] object-contain rotate-[90deg] lg:w-[28px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px] w-[48px]"
                          alt="Arrow"
                        />
                      </Row>
                    </Column>
          ...
          <Column className="bg-gray_800 items-center justify-end w-[100%]">
            <Row className="items-start justify-evenly lg:mt-[37px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] mt-[64px] w-[100%]">
              <Column className="items-start justify-start lg:mb-[15px] xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] w-[22%]">
                ...
                <div className="2xl:mr-[7px] 2xl:mt-[26px] 3xl:mr-[9px] 3xl:mt-[31px] lg:mr-[5px] lg:mt-[20px] mr-[10px] mt-[35px] w-[91%] xl:mr-[6px] xl:mt-[23px] input-wrap">
                  <Image
                    src="img_arrow_4.svg"
                    className="absolute right-[16px] lg:right-[9px] xl:right-[10px] 2xl:right-[12px] 3xl:right-[14px] my-[auto] inset-y-[0]"
                    alt="Arrow"
                  />
                  <Button className="bg-white_A700 font-normal not-italic xl:pb-[12px] 3xl:pb-[16px] pb-[18.545px] lg:pl-[14px] xl:pl-[16px] 2xl:pl-[18px] 3xl:pl-[21px] pl-[24px] lg:pr-[56px] xl:pr-[64px] 2xl:pr-[72px] 3xl:pr-[86px] pr-[96px] xl:pt-[11px] 3xl:pt-[15px] pt-[17.545px] lg:py-[10px] 2xl:py-[13px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500_87 text-left tracking-ls1 w-[100%]">{`Enter your email`}</Button>
                </div>
              </Column>
