                ...
                <div className="absolute bg-transparent border-0 bottom-[0] mb-[0] w-[100%] input-wrap">
                  <div className="input-wrap">
                    <Image
                      ...
                      className="absolute h-[24px] left-[0] bg-transparent border-0 lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] my-[auto] inset-y-[0]"
                      alt="chevron-down"
                    />
                    <Input
                      className="placeholder:bg-transparent bg-transparent border-0 border-b-[1px] border-bluegray_100 border-solid font-normal inset-x-[0] not-italic lg:pb-[21px] xl:pb-[24px] 2xl:pb-[27px] 3xl:pb-[32px] pb-[36.045px] lg:pl-[14px] xl:pl-[16px] 2xl:pl-[18px] 3xl:pl-[21px] pl-[24px] lg:pt-[1px] 3xl:pt-[2px] 2xl:pt-[2px] xl:pt-[2px] pt-[3.045px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 placeholder:text-gray_500 text-gray_500 text-left w-[100%]"
                      name="View more"
                  ...
                  <Row className="lg:gap-[18px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] gap-[32px] grid grid-cols-5 items-center justify-between xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] w-[100%]">
                    <Column className="items-center w-[100%]">
                      <Image
                        ...
                        className="lg:h-[143px] xl:h-[164px] 2xl:h-[184px] 3xl:h-[221px] h-[245px] object-cover rounded-radius50 w-[100%]"
                        alt="placeholder"
                      />
